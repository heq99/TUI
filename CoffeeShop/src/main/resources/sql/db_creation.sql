...
insert into PRODUCT ("ID", "NAME", "DESCRIPTION", "DEFAULT_PRICE", "PRODUCT_BRAND_ID", "PRODUCT_TYPE_ID") values(1, 'Flat White', 'A rich, full-flavoured coffee with a velvety, smooth texture finished with a distinctive leaf pattern.',225 , 1, 1);
